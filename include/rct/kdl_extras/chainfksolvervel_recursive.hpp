...
#ifndef KDL_CHAIN_FKSOLVERVEL_RECURSIVE_EXTRAS_HPP
#define KDL_CHAIN_FKSOLVERVEL_RECURSIVE_EXTRAS_HPP

#include "kdl_extras/chainfksolver.hpp"
...
namespace KDL
{
     ...
     */
    class ChainFkSolverVel_recursive_extras : public ChainFkSolverVelExtras
    {
    public:
        ChainFkSolverVel_recursive_extras(const Chain& chain);
        ~ChainFkSolverVel_recursive_extras();
